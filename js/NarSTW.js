...
function toggleMute() {
    var video = document.getElementById('NarSTW');
    if (video.muted) {
        video.muted = false;
    } else {
        video.muted = true;
...
function showVideo() {
    var element = document.getElementById('NarSTW');
...
document.getElementById('NarSTW').addEventListener('ended', introFinished, false);