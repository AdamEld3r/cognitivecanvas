...
function toggleMute() {
    var video = document.getElementById('IDAdamSITvideo');
    if (video.muted) {
        video.muted = false;
    } else {
        video.muted = true;
...
function showVideo() {
    var element = document.getElementById('IDAdamSITvideo');
...
document.getElementById('IDAdamSITvideo').addEventListener('ended', introFinished, false);